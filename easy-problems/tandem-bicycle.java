...
class TandemBicycle {
    ...
    /**
     * Tandem bike = bike operated by 2 people. The person that pedals faster
     * dictates speed. tandemSpeed = max(speedA, speedB)
     * 
     * Pair every rider wearing red with a rider wearing blue
     * 
     * Return the max possible total speed or the min possible total speed of all
     * the tandem bicycles being ridden. based of input fastest.
     * 
