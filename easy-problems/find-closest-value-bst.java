class Problem6 {
    ...
    public static int findClosestValueInBst(BST tree, int target, int closest) {
        // Always start with the base case. If you've reached the leaf node without children you should've already arrived at your solution 
		if (tree == null) { 
			return closest; 
		} 

        // Update the closest node. The smaller the difference the closer we are to the target. 
    ...
    /** 
     * O(logn) time complexity; O(logn) extra space complexity for the recursive stack. 
     * @param tree
     * @param target
     * @return int
     */
